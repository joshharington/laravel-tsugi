...
$CFG->pdo       = 'mysql:host=127.0.0.1;dbname=' . env('DB_DATABASE', 'tsugi');
// $CFG->pdo       = 'mysql:host=127.0.0.1;port=8889;dbname=tsugi'; // MAMP
$CFG->dbuser    = env('DB_USERNAME', 'ltiuser');
$CFG->dbpass    = env('DB_PASSWORD', 'ltipassword');
...
$CFG->vendorroot = "/util";
$CFG->vendorinclude = "/include";
$CFG->vendorstatic = "/static";

// Leave these here
require_once "include/setup.php";
require_once "include/lms_lib.php";
